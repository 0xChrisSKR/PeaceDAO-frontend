...
export default function SiteNav() {
  ...
  // ✅ 定義清楚型別，避免 TS 把 key 誤認成字串 literal
  ...
  return (
    <nav
      className="flex items-center justify-center gap-6 py-5 text-sm font-medium text-white/90"
        ...
        return (
          <Link
            ...
            className={`transition-all ${
              active
                ? 'text-white border-b-2 border-[#00bfa5]'
