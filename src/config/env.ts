const chainId = Number.parseInt(process.env.NEXT_PUBLIC_CHAIN_ID ?? "56", 10) || 56;
const peaceTokenAddress =
...
const env = {
  ...
  peaceSwapRouter: process.env.NEXT_PUBLIC_PEACESWAP_ROUTER ?? "",
  peaceTokenAddress,
  peaceToken: peaceTokenAddress,
